  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_1_538}>
        <Text style={styles.Text_1_538}>Nikopolidis Papadopulus</Text>
      </View>
      <View style={styles.View_1_539}>
        <View style={styles.View_1_540} />
        <View style={styles.View_1_541}>
          <Text style={styles.Text_1_541}>Bio</Text>
        </View>
      </View>
      ...
      <View style={styles.View_1_547}>
        ...
        <View style={styles.View_1_568}>
          <Text style={styles.Text_1_568}>powered by</Text>
        </View>
      ...
      <View source={{ uri: "null" }} style={styles.View_1_579} />
...
const styles = StyleSheet.create({
  ...
  View_1_579: {
    ...
    height: hp("7.714565277099609%"),
    minHeight: hp("7.714565277099609%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
    left: wp("82.01301574707031%"),
    top: hp("6.571428571428571%")
  },
  View_2: { height: 700 }
})
