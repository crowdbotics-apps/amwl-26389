  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_1_304}>
        <Text style={styles.Text_1_304}>Nikopolidis Papadopulus</Text>
      </View>
      <ImageBackground
        source={{
          uri:
      ...
      <View style={styles.View_1_381}>
        ...
        <View style={styles.View_1_383}>
          <Text style={styles.Text_1_383}>Bio</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  View_1_371: {
    width: wp("95.06944444444444%"),
    minWidth: wp("95.06944444444444%"),
